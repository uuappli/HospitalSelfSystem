...
{
    public partial class FrmRegisterReadCard : Form
    {
        private int times = 0;
        ...
        private void backgroundWorker1_RunWorkerCompleted(object sender, RunWorkerCompletedEventArgs e)
        {
            ...
            else
            {
                ...
                PictureBoxVisable(this.pGH, true);
            }
        }

        private void FrmRegisterReadCard_Load(object sender, EventArgs e)
        {
            timer1.Start();
        }
        ...
        private void pGH_Click(object sender, EventArgs e)
        {
            timer2.Stop();
            FrmNewOfficeList frm = new FrmNewOfficeList();
            frm.ShowDialog();
