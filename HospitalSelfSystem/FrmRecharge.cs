    ...
    public partial class FrmRecharge : Form
    {
        ...
        private void backgroundWorker1_RunWorkerCompleted(object sender, RunWorkerCompletedEventArgs e)
        {
            ...
            else
            {
                ...
                PictureBoxVisable(this.pCARD, true);
                PictureBoxVisable(this.pCASH, true);
            }
        }
        ...
        private void pCARD_Click(object sender, EventArgs e)
        {

        }

        private void FrmRecharge_FormClosed(object sender, FormClosedEventArgs e)
        {
            this.timer1.Stop();
        }
