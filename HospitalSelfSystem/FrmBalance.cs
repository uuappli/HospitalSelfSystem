...
namespace HospitalSelfSystem
{
    public partial class FrmBalance : Form
    {
        ...
        private void backgroundWorker1_RunWorkerCompleted(object sender, RunWorkerCompletedEventArgs e)
        {
            ...
            {
                LableText(this.labMoney, FrmMain.cardBlance.ToString("0.00"));
                LableVisable(this.labMoney, true);
                LableText(this.label2, FrmMain.parInfo.Tables[0].Rows[0]["姓名"].ToString());
        ...
        {
            timer2.Stop();
            FrmCardRechargeDetail frm = new FrmCardRechargeDetail();
            frm.ShowDialog();
            this.Close();
        }
